...
public class LandMain {
    ...
    public static void main(String[] args) {
        ...
        landen.add(new Land("AG", "Argentinie", "BuenosAires", BigInteger.valueOf(38500000L), BigDecimal.valueOf(2825647.56)));
        ...
        gemBevolkingsdichtheid = (new BigDecimal(totInwoners)).divide(totOppervlakte, 2, RoundingMode.HALF_UP);
        ...
        System.out.println(" Het land dat het dichtst aanleunt bij dit gemiddelde is " + hetLand.getLandNaam() + " met een bevolkingsdichtheid van " + fmt.format(hetLand.bevolkingsDichtHeid()));
